...
export const name = "Code Review Agent";
...
const IMAGE_NAME = "strands-agents-code-review-agent";
...
const PIPE_FUNCTION_ID = "strands_agents_code_review_agent";
const PIPE_FUNCTION_NAME = "Strands Agents - Code Review Agent";
...
export async function install() {
  ...
  const agentVars = {
    ...
    arch,
    IMAGE: IMAGE_URL,
    ...config["examples"]["strands-agents"]["code-review-agent"].env,
